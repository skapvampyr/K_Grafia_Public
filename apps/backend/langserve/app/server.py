...
# os.environ["AZURE_OPENAI_MODEL_NAME"] = os.environ["GPT4o_DEPLOYMENT_NAME"]
...
# Set LLM
llm = AzureChatOpenAI(deployment_name=os.environ.get("AZURE_OPENAI_MODEL_NAME"), temperature=0.0, max_tokens=2000, streaming=True)
...
#                              name="csv_TCK",
#                              description="useful when the questions includes the term: TICKET, TICKETS, SOLICITUD, SOLICITUDES, SERVICE DESK",
#                              verbose=True)

# file_url = "./data/SF.csv"
# csv_search_SF = CSVTabularAgent(path=file_url, llm=llm, callback_manager=cb_manager,
#                              name="csv_SF",
#                              description="useful when the questions includes the term: OP, OPORTUNIDAD, OPORTUNIDADES, TCV, MRC, SALESFORCE",
#                              verbose=True)

# file_url = "./data/CMDB.csv"
# csv_search_CMDB = CSVTabularAgent(path=file_url, llm=llm, callback_manager=cb_manager,
#                              name="csv_CMDB",
#                              description="useful when the questions includes the term: INVENTARIO, DISPOSITIVOS, CMDB",
#                              verbose=True)
